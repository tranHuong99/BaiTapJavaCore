...
<html>
    ...
    <body>
        <div class="container">
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="laptrinhCcanban">Lập trình C căn bản</a>
                                        <a class="dropdown-item" href="giaithuatcanban">Khóa học Giải thuật căn bản</a>
                                        <a class="dropdown-item" href="giaithuatnangcao">Khóa học Giải thuật nâng cao</a>
                                    </div>
                                </li>
                                <li class="nav-item">
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="http://www.hocvienact.edu.vn/images/slider/LaptrinhC.png" class="d-block w-100" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <a href="${contextPath}/dangkyhoc?course=1" class="btn btn-primary">Đăng ký ngay</a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <br/>
            ...
            <br/>
            <a class="btn btn-danger" style="width: 150px; font-size: 25px" href="${contextPath}/dangkyhoc?course=1">Đăng ký</a>
        </div>
        <script
