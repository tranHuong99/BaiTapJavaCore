        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    Trang chủ > Lập trình bằng ngôn ngữ tự nhiên
                </div>
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <a href="${contextPath}/dangkyhoc?course=0" class="btn btn-primary">Đăng ký ngay</a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <br/>
                            <img style="width: 350px; height: 300px" src="https://afamilycdn.com/thumb_w/600/2019/7/6/3287244-phuong-phap-ren-luyen-su-0-1562381338966862147607-crop-1562381361168954311302.jpg" class="card-img">
                        </div>
                    </div>
                </div>
                <br/><br/>
            ...
            <br/>
            <a class="btn btn-danger" style="width: 150px; font-size: 25px" href="${contextPath}/dangkyhoc?course=0">Đăng ký</a>
        </div>
        <script
