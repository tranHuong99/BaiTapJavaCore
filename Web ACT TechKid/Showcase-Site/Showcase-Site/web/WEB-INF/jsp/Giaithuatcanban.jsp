        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    Trang chủ > Giải thuật căn bản
                </div>
                <div class="card mb-3" style="border: none">
                    <div class="row no-gutters">
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title">Giải thuật căn bản</h5>
                                ...
                                <a href="${contextPath}/dangkyhoc?course=2" class="btn btn-primary">Đăng ký ngay</a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <br/>
            ...
            <br/>
            <a class="btn btn-danger" style="width: 150px; font-size: 25px" href="${contextPath}/dangkyhoc?course=2">Đăng ký</a>
        </div>
        <script
